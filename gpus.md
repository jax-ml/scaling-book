...
**GPUs are more modular.** TPUs have 1-2 big Tensor Cores, while GPUs have hundreds of small SMs. Likewise, each Tensor Core has a big VPU with an 8×128 vector engine where each lane/sublane pair has 4 independent ALUs; for GPU comparisons, we view this as 4 independent SIMD units each with 1024 ALUs, while an H100 has 132 * 4 = 528 small independent SIMD units. Here is a 1:1 comparison of GPUs to TPU that highlights this point:
