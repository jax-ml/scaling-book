...
**W<sub>in</sub> of these exceed the memory usage of our parameters!** To be clear, LLaMA 2 was not optimized for KV cache size at longer contexts (it isn't always this bad —— usually $$K$$ is much smaller, as in LLaMA-3), but this is still illustrative. We cannot neglect these either in memory or latency estimates.
